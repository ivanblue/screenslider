...
!(function (a, b) {
              ...
              (a = g[d]),
                ...
                g !== c &&
                  (j && c && (n.isPlainObject(c) || (b = n.isArray(c)))
                    ? (b ? ((b = !1), (f = a && n.isArray(a) ? a : [])) : (f = a && n.isPlainObject(a) ? a : {}),
                      (g[d] = n.extend(j, f, c)))
                    : void 0 !== c && (g[d] = c));
        return g;
      }),
  ...
  (n.filter = function (a, b, c) {
    ...
    n.fn.extend({
      find: function (a) {
        ...
        return (
          (c = this.pushStack(e > 1 ? n.unique(c) : c)), (c.selector = this.selector ? this.selector + ' ' + a : a), c
        );
      },
      filter: function (a) {
  ...
  var A,
    ...
    C = (n.fn.init = function (a, b, c) {
      ...
      if (((c = c || A), 'string' == typeof a)) {
        if (
          ((e = '<' === a.charAt(0) && '>' === a.charAt(a.length - 1) && a.length >= 3 ? [null, a, null] : B.exec(a)),
          !e || (!e[1] && b))
        )
  ...
  n.fn.extend({
    ...
    closest: function (a, b) {
      for (
        var c, d = 0, e = this.length, f = [], g = w.test(a) || 'string' != typeof a ? n(a, b || this.context) : 0;
        e > d;
        d++
      )
  ...
  (n.ready.promise = function (b) {
    if (!I)
      if (
        ((I = n.Deferred()), 'complete' === d.readyState || ('loading' !== d.readyState && !d.documentElement.doScroll))
      )
  ...
  (n.event = {
      ...
      if (r && (k = r.events)) {
        ...
        while (j--)
          if (((h = oa.exec(b[j]) || []), (o = q = h[1]), (p = (h[2] || '').split('.').sort()), o)) {
            ...
            i &&
              !m.length &&
              ((l.teardown && l.teardown.call(a, p, r.handle) !== !1) || n.removeEvent(a, o, r.handle), delete k[o]);
    ...
    l.submit ||
      (n.event.special.submit = {
        ...
        postDispatch: function (a) {
          a._submitBubble &&
            (delete a._submitBubble, this.parentNode && !a.isTrigger && n.event.simulate('submit', this.parentNode, a));
        },
        teardown: function () {
      ...
      attr: function (a, b, c) {
        ...
        if (3 !== f && 8 !== f && 2 !== f)
          return 'undefined' == typeof a.getAttribute
            ? n.prop(a, b, c)
            : ((1 === f && n.isXMLDoc(a)) ||
                ((b = b.toLowerCase()), (e = n.attrHooks[b] || (n.expr.match.bool.test(b) ? ub : tb))),
              void 0 !== c
                ? null === c
  ...
  (n.parseJSON = function (b) {
    ...
    (n.parseXML = function (b) {
      ...
      return (
        (c && c.documentElement && !c.getElementsByTagName('parsererror').length) || n.error('Invalid XML: ' + b), c
      );
    });
  var Hb = /#.*$/,
    Ib = /([?&])_=[^&]*/,
      ...
      if (
        ...
        null == l.crossDomain &&
          ...
          (l.crossDomain = !(
            ...
            (d[1] === Sb[1] &&
              d[2] === Sb[2] &&
              (d[3] || ('http:' === d[1] ? '80' : '443')) === (Sb[3] || ('http:' === Sb[1] ? '80' : '443')))
          ))),
